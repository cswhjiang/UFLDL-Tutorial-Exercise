...
images = loadMNISTImages('../mnist/train-images-idx3-ubyte'); % d* n
labels = loadMNISTLabels('../mnist/train-labels-idx1-ubyte');
labels(labels==0) = 10; % Remap 0 to 10

inputData = images;
% [inputData,P] = zcaWhiten(inputData); %%%%%%%%%%%%%%%%%%%
...
average_error = grad_check(@softmaxCost, theta, 1000, numClasses, inputSize, lambda, inputData, labels);
